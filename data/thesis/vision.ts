export const thesisVision = {
  ...
  visionLine:
    "A research prototype that transforms thousands of news articles into geographically structured impact signals, helping identify and forecast drought-related impacts across the Netherlands.",
  ...
  pipelineSteps: [
    ...
    "Supervised machine learning for impact prediction (Random Forest)",
